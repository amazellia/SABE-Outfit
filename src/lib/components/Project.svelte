...
<div use:storyblokEditable={blok}>
    ...
    <div class="grid justify-items-center mx-auto mb-12">
        <h1 class="text-2xl lg:text-6xl text-[#ff0085] font-bold mt-12 mb-4 text-center">{blok.title}</h1>
        <h2 class="text-xl lg:text-2xl text-[#1d243d] font-bold mb-4">
            {blok.subtitle}
        </h2>
        <div class="prose flex items-center flex-col rich_style">{@html resolvedRichText}</div>
    </div>
</div>
