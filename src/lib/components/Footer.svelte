...
<footer class="p-12">
    <div class="flex flex-col lg:flex-row justify-stretch">
        ...
        <div class="hidden md:block lg:block basis-auto lg:basis-1/4 flex justify-center items-center text-center">
            ...
            src={logo.filename}
            alt={logo.alt}
            class="w-auto h-20 lg:h-1/2 flex justify-center items-center text-center"
            />
        </div>
        <div class="basis-auto p-6 lg:basis-1/6 text-[#ff0085]">
            <b class="no-underline bold">Contact Us</b><br>
            <a class=" text-[#ff0085] underline underline-offset-8" href={footer.phone}>Phone</a> <br>
            <a class=" text-[#ff0085] underline underline-offset-8" href="mailto:{footer.email}">Email</a> <br><br>
    ...
    <div  class="flex items-center justify-center text-xl lg:text-2xl text-[#ff0085] font-bold text-center p-8">
        {footer.copyright}
    </div>
</footer>